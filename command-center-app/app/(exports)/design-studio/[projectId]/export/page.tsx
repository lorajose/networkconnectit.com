...
export default async function DesignStudioExportPage({ params, searchParams }: DesignExportPageProps) {
  ...
  return <main className="mx-auto max-w-6xl space-y-8 bg-white p-8 text-slate-950 print:max-w-none print:p-0">
    ...
    <footer className="border-t pt-4 text-xs text-slate-500">Generated from Design Studio revision {project.workingRevision}. {profile.clientSafe ? "Client-safe profile excludes internal pricing." : "Internal profile may include commercial pricing."} Issued-client reports must be preserved as immutable revision snapshots.</footer>
  </main>;
}
