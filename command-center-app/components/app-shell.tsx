      ...
      <div className="relative mx-auto max-w-[1600px] p-4 sm:p-6">
        <div className="grid min-w-0 gap-6 xl:grid-cols-[296px_minmax(0,1fr)]">
              ...
              <Card className="command-surface shrink-0 border-sky-400/15">
                <CardContent className="space-y-5 p-5">
                  <div className="flex items-start justify-between gap-4">
                    <Link href="/dashboard" className="min-w-0 space-y-3">
                      <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-sky-400/15 text-sky-300">
                        <Shield className="h-6 w-6" />
                      </div>
                      <div>
                        <p className="text-lg font-semibold text-foreground">NetworkConnectIT</p>
                  ...
                  <div className="rounded-2xl border border-border/70 bg-background/40 p-3">
                    <p className="text-xs uppercase tracking-[0.22em] text-primary">Operations fabric</p>
                    <p className="mt-2 text-sm leading-6 text-muted-foreground">Unified visibility for client sites, devices, and infrastructure worldwide.</p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-3 p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 space-y-1">
                      <p className="truncate text-sm font-medium text-foreground">{user.name ?? "Authenticated User"}</p>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div className="min-w-0">
                      <p className="text-[11px] uppercase tracking-[0.22em] text-muted-foreground/70">Session scope</p>
                      <p className="mt-1 truncate text-sm text-foreground">{user.organizationId ? `Org ${user.organizationId}` : "Global access"}</p>
                    </div>
          ...
          <div className="min-w-0 space-y-6">
            <Card className="command-surface min-w-0 border-border/80">
              <CardContent className="flex min-w-0 flex-col gap-4 p-5 lg:flex-row lg:items-center lg:justify-between">
                <div className="min-w-0 space-y-2">
                  ...
                  <div className="min-w-0 space-y-1">
                    ...
                    <p className="max-w-3xl text-sm leading-6 text-muted-foreground">Unified visibility for client sites, devices, and infrastructure worldwide.</p>
                  </div>
                </div>
